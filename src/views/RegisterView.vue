                ...
                <v-form @submit.prevent="register" ref="form">
                  ...
                  <p class="text-warning">
                    ...
                    ใช้ได้แค่ gmail, hotmail, mfu.ac.th, lamduan.mfu.ac.th
                        ...
                        <v-col cols="12" md="6">
                            <v-text-field v-model="form.email" label="อีเมล" prepend-inner-icon="mdi-email-outline"
                                variant="outlined" outlined color="#BA984C"
                                :rules="[rules.required, rules.email, rules.notEmpty]" required></v-text-field>
                        </v-col>

                        <v-col cols="12" md="6">
                            <v-text-field v-model="form.phone" label="เบอร์โทรศัพท์"
                                prepend-inner-icon="mdi-phone-outline" variant="outlined" outlined color="#BA984C"
                                :rules="[rules.required, rules.phone, rules.notEmpty]" required></v-text-field>
                        </v-col>
                    ...
                    <div class="text-center justify-center pt-5 flex text-base">
                        <p>
                            <router-link to="/login" class="px-2 hover:underline" style="color: #ba984c">
                                เข้าสู่ระบบ
                            </router-link>
                        </p>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                phone: (v) =>
                    /^\d{10}$/.test(v) || 'Invalid phone number, must be 10 digits',
