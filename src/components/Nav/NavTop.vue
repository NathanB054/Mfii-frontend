            ...
            <div class="hidden md:flex justify-center h-16 items-center">
                <ul class="flex items-center w-full max-w-2xl justify-between max-w-screen-xl">
                    ...
                    <div class="hover:bg-gray-400 rounded-md transition-colors duration-300"
                        ...
                        <button class="text-white hover:text-gray-900 px-3 py-2 text-sm font-medium inline-flex items-center"
                            ...
                            <li>
                                <button 
                                    ...
                                    <svg class="w-4 h-4 ml-1 transition-transform duration-200"
                                         :class="{ 'transform rotate-180': activeDropdown === section.name }"
                                ...
                                <Transition
                                    ...
                                    <div v-if="activeDropdown === section.name"
                                        ...
                                        <RouterLink v-for="(item, itemIndex) in section.items" 
                                            :key="itemIndex" 
                                            :to="item.to"
