        ...
        <v-col cols="12" md="4">
          <h3>
            <blockquote>
              ...
              <p style="color: #fff; font-size: 14px;">มหาวิทยาลัยแม่ฟ้าหลวง</p>
            </blockquote>
          </h3>
        </v-col>
        <v-col cols="6" md="4">
          ...
          <ul class="mfu-social flex space-x-4">
            <li class="group rounded-full bg-white">
              <a
                ...
                target="_blank"
                class="w-8 h-8 rounded-full flex justify-center items-center transition duration-500 ease-in-out group-hover:bg-blue-700"
              >
                <v-icon
                  class="mdi mdi-facebook text-xl text-blue-700 group-hover:text-white"
                ></v-icon>
              </a>
            </li>
            <li class="group rounded-full bg-white">
              <a
                ...
                target="_blank"
                class="w-8 h-8 rounded-full flex justify-center items-center transition duration-500 ease-in-out group-hover:bg-red-700"
              >
                <v-icon
                  class="mdi mdi-youtube text-xl text-red-700 group-hover:text-white"
                ></v-icon>
              </a>
            </li>
            <li class="group rounded-full bg-white">
              <a
                ...
                target="_blank"
                class="w-8 h-8 rounded-full flex justify-center items-center transition duration-500 ease-in-out group-hover:bg-green-600"
              >
                <v-icon
                  class="mdi mdi-chat text-xl text-green-600 group-hover:text-white"
                ></v-icon>
              </a>
            </li>
          </ul>
